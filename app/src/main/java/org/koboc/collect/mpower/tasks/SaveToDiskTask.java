...
package org.koboc.collect.mpower.tasks;
...
import org.koboc.collect.mpower.application.Collect;
import org.koboc.collect.mpower.listeners.FormSavedListener;
import org.koboc.collect.mpower.logic.FormController;
import org.koboc.collect.mpower.provider.InstanceProviderAPI;
import org.koboc.collect.mpower.utilities.EncryptionUtils;
import org.koboc.collect.mpower.provider.FormsProviderAPI;
...
public class SaveToDiskTask extends AsyncTask<Void, String, Integer> {
    ...
    private void updateInstanceDatabase(boolean incomplete, boolean canEditAfterCompleted) {
        ...
        if (Collect.getInstance().getContentResolver().getType(mUri) == InstanceProviderAPI.InstanceColumns.CONTENT_ITEM_TYPE) {
        ...
        } else if (Collect.getInstance().getContentResolver().getType(mUri) == FormsProviderAPI.FormsColumns.CONTENT_ITEM_TYPE) {
